  ...
  return (
    <div className=''>
      <div className="flex w-8/12 mx-auto my-10">
        <div className='mr-20'>
           <Image src={product.image} height={400} width={300} alt={product.name} />
        </div>
               ...
               <div className="w-[56%] my-[2%]">
                 ...
                 <div className="bg-amber-500 p-1 rounded-2xl text-xs w-30 text-center mb-2 text-white">Brand: {product.brand}</div>
                      ...
                      <p> 
                      <span className=" font-bold mr-2 text-[#f3790d]">${product.price}</span>
                        </p>
                        
                        <p className="bg-red-600 p-1 rounded-2xl text-xs w-30 text-center mb-2 mt-3 text-white">{product.tag}</p>
