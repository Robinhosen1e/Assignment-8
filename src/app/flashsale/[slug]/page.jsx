           ...
           <Image src={product.image} height={400} width={400} alt={product.name} />
               ...
               <div className="w-[56%] my-[2%]">
                 ...
                 <div className="bg-amber-500 p-1 rounded-2xl text-xs w-30 text-center mb-2 text-white">Brand: {product.brand}</div>
                    ...
                    <p> 
  <span className=" font-bold mr-2 text-[#f3790d]">${product.originalPrice}</span>
  <span className="line-through text-gray-500">${product.salePrice}</span>
    </p>
                        
                        <p className="bg-red-600 p-1 rounded-2xl text-xs w-30 text-center mb-2 mt-3 text-white">Discount: {product.discount}</p>
